    ...
    public class ManageController : Controller
    {
        ...
        public async Task<ActionResult> UploadPhoto(HttpPostedFileBase file)
        {
            if (file != null && file.ContentLength > 0)
            {
                ...
                var newFileExt = username + ".png";
                var toLowerExtension = fileExt.ToLower();

                if (toLowerExtension.EndsWith(".png") ||
                    toLowerExtension.EndsWith(".jpg") ||
                ...
                {
                    this.AddNotification("Only jpg, jpeg, png and gif file formats are allowed!", NotificationType.WARNING);

                    return RedirectToAction("Index");
                }
            }

            this.AddNotification("Please try again!", NotificationType.ERROR);
